...
COLUMNS = [
    ...
    "price", "beds", "baths", "sqft", "pets_allowed", "dog_policy", "dog_policy_evidence",
...
_NEW_COLUMNS: list[tuple[str, str, str]] = [
    ...
    ("listings", "dog_policy_evidence", "TEXT"),
...
def _listing_to_row(L: Listing) -> dict:
    return {
        ...
        "dog_policy_evidence": L.dog_policy_evidence,
        "parking": L.parking,
        "laundry": L.laundry,
...
def _row_to_listing(row: sqlite3.Row) -> Listing:
    return Listing(
        ...
        dog_policy_evidence=row["dog_policy_evidence"],
        parking=row["parking"],
        laundry=row["laundry"],
